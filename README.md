> This is a fork. Not a replacement. Bun you can compare its per-platform installation with `npm install github:Guthib-of-Dan/uWebSockets.js#v0.0.1` or `bun install "github:Guthib-of-Dan/uWebSockets.js#v0.0.1" && bun pm trust uWebSockets.js`. It uses "postinstall" script so only one binary is installed
<div align="center">
