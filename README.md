> This is a fork. Not a replacement. But you can compare its per-platform installation with `npm install github:Guthib-of-Dan/uWebSockets.js#v0.0.1` or `bun install "github:Guthib-of-Dan/uWebSockets.js#v0.0.1" && bun pm trust uWebSockets.js`. It uses "postinstall" script to download only necessary binary, rather than all at once.
<div align="center">
...
* `npm install uNetworking/uWebSockets.js#v0.0.1`
