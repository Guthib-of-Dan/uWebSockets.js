...
export declare class DeclarativeResponse<HeadersType = Record<string, string>> {
    ...
    writeQueryValue(key: string): this;
    writeHeaderValue(key: string): this;
 ...
 */
export type RecognizedString = string | ArrayBuffer | TypedArray;
...
export interface TemplatedApp {
    ...
    listen(host: RecognizedString, port: number, options: ListenOptions, cb: (listenSocket: us_listen_socket | false) => void | Promise<void>): this;
    /** Listens to port. Callback hands either false or a listen socket. */
    listen(port: number, cb: (listenSocket: us_listen_socket | false) => void | Promise<void>): this;
    ...
    /** Adds a server name. */
    addServerName(hostname: string, options: AppOptions): this;
    ...
    removeServerName(hostname: string): this;
    /** Registers a synchronous callback on missing server names. See /examples/ServerName.js. */
    missingServerName(cb: (hostname: string) => void): this;
    /** Attaches a "filter" function to track socket connections / disconnections */
    filter(cb: (res: HttpResponse, count: Number) => void | Promise<void>): this;
...
export declare function us_socket_local_port(socket: us_socket | us_listen_socket): number;
...
export declare function getParts(body: RecognizedString, contentType: RecognizedString): MultipartField[] | undefined;
